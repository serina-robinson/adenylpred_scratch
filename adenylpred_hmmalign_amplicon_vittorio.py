...
def make_prediction(fasta_dir, silent):
    ...
    filename = "%s/data/models/best_rf_train0.9_rep3_groups_amplicon_model.sav" % parent_folder
    # filename = "%s/data/models/best_rf_train0.9_rep4_monomers_amplicon_model.sav" % parent_folder
